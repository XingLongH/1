...
def main():
    ...
    test_ir_path = "/mnt/Disk1/huxinglong/data/MSRS_testimage/ir_256/"
    test_vis_path = "/mnt/Disk1/huxinglong/data/MSRS_testimage/vi_256/"
    files = os.listdir(test_ir_path)
    ...
    with torch.no_grad():
        ...
        for j in range(1):       #####
            ...
            for i in files:
                index = i 
                infrared_path = test_ir_path + str(index) #+ 'IR' + str(index) + '.png'
                visible_path = test_vis_path + str(index) #+ 'VIS' + str(index) + '.png'
