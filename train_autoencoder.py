...
def train(i, original_imgs_path):
	...
	# nest_model = Encoder(nb_filter, input_nc, output_nc, deepsupervision)
...
# 		
		...
		save_model_filename = "Finnaly_Epoch_" + str(e) + ".model"
		save_model_path = os.path.join(args.save_model_dir_autoencoder, save_model_filename)
		torch.save(nest_model.state_dict(), save_model_path)
		tbar.set_description("\nCheckpoint, Finnaly_trained model saved at", save_model_path)
